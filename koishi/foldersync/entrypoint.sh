...
cp -r /tmp/foldersync-sshkeys-user-cc /home/${USER_CC}/.ssh
chown -R ${USER_CC}:${USER_CC} /home/${USER_CC}
chmod 700 /home/${USER_CC}/.ssh
chmod 600 /home/${USER_CC}/.ssh/*

cp -r /tmp/foldersync-sshkeys-user-001 /home/${USER_001}/.ssh
chown -R ${USER_001}:${USER_001} /home/${USER_001}
chmod 700 /home/${USER_001}/.ssh
chmod 600 /home/${USER_001}/.ssh/*
